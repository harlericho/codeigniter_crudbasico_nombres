...
<body>
        ...
        <div class="row">
            <div class="col-md">
                <div class="card-header mt-5">
                    <h3><img src="<?= 'dist/list.ico' ?>" width="30" height="30">
                        Listado de nombres
                    </h3>
                </div>
                ...
                <div class="card-body">
                    <div id="tabla-nombres" class="table table-responsive mt-3"></div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <i class="fas fa-id-badge"></i> Añadir Nombres
                    </h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"> <i
                        ...
                        Cerrar</button>
                    <button type="button" class="btn btn-info" id="btnGuardar"> <i class="fas fa-save"></i>
                        Guardar</button>
                </div>
            </div>
        </div>
    ...
    <script src="<?= 'dist/principal.js' ?>" type="text/javascript"></script>
